...
static struct audio_custom_mtmx_params *update_channel_weightage_params(struct audio_custom_mtmx_params_info *pinfo,
                                        ...
                                        bool enable)
{
    ...
    struct audio_out_channel_map_param *in_channel_map_param = NULL;
