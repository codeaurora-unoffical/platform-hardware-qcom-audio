...
enum {
    ...
    SND_DEVICE_OUT_BT_PRI_SCO,
    SND_DEVICE_OUT_BT_SEC_SCO,
    SND_DEVICE_OUT_BT_SCO_WB,
    SND_DEVICE_OUT_BT_PRI_SCO_WB,
    SND_DEVICE_OUT_BT_SEC_SCO_WB,
    ...
    SND_DEVICE_IN_BT_PRI_SCO_MIC,
    SND_DEVICE_IN_BT_SEC_SCO_MIC,
    SND_DEVICE_IN_BT_SCO_MIC_NREC,
    SND_DEVICE_IN_BT_SCO_MIC_WB,
    SND_DEVICE_IN_BT_PRI_SCO_MIC_WB,
    SND_DEVICE_IN_BT_SEC_SCO_MIC_WB,
...
enum {
    ...
    SPDIF_RX_BACKEND,
    OPTICAL_RX_BACKEND,
    MAX_RX_CODEC_BACKENDS = OPTICAL_RX_BACKEND,
    /* TX BE follows RX BE */
    SLIMBUS_0_TX,
...
#define PLAYBACK_OFFLOAD_DEVICE2 24
    ...
    defined (PLATFORM_BENGAL) || defined (PLATFORM_SDX55)
...
#define HFP_SEC_SCO_RX 56
#define HFP_SEC_ASM_RX_TX 57
#elif defined (PLATFORM_MSMFALCON) || defined (PLATFORM_MSM8937)
#define HFP_SCO_RX 17
#define HFP_ASM_RX_TX 18
#define HFP_SEC_SCO_RX -1
...
#define AFE_LOOPBACK_RX_DEV_ID 2
#define AFE_LOOPBACK_TX_DEV_ID 9
#define DTMF_TX_DEV_ID 5
