...
ifneq ($(filter msm8974 msm8226 msm8610 apq8084 msm8994 msm8992 msm8996 msm8996_gvmq,$(TARGET_BOARD_PLATFORM)),)
...
ifneq ($(filter msm8996_gvmq,$(TARGET_BOARD_PLATFORM)),)
  LOCAL_CFLAGS := -DPLATFORM_MSM8996
endif
endif
...
ifeq ($(strip $(AUDIO_FEATURE_ENABLED_VAD)),true)
    LOCAL_CFLAGS += -DVAD_ENABLED
    LOCAL_SRC_FILES += audio_extn/vad.c
endif
...
ifeq ($(strip $(AUDIO_FEATURE_ENABLED_APTX_OFFLOAD)),true)
    LOCAL_CFLAGS += -DAPTX_OFFLOAD_ENABLED
    LOCAL_CFLAGS += -DCOMPRESS_METADATA_NEEDED
endif
...
ifeq ($(strip $(AUDIO_FEATURE_ENABLED_LINE_IN_PASSTHROUGH)),true)
    LOCAL_CFLAGS += -DLINE_IN_PASSTHROUGH_ENABLED
endif

ifeq ($(strip $(AUDIO_FEATURE_ENABLED_HDMI_IN_PASSTHROUGH)),true)
    LOCAL_CFLAGS += -DHDMI_IN_PASSTHROUGH_ENABLED
endif
...
ifeq ($(strip $(AUDIO_FEATURE_ENABLED_EXT_AUDIO_ANC)),true)
    LOCAL_CFLAGS += -DEXT_AUDIO_ANC_ENABLED
