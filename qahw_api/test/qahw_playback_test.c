...
void usage() {
    ...
    printf(" hal_play_test -g /data/audio/play.txt -k 1 -t 21 -r 48000 -c 2 -v 0.5 \n");
    printf("                                          -> gapless playback (-g = /data/audio/play.txt) ");
    printf("                                          -> Play amrwbplus clip (-t = 21)\n");
    printf("                                          -> kvpair(-k) values represent media-info of clip & values should be in below mentioned sequence\n");
    printf("                                          -> vorbis_bitstream_fmt\n");
}
        ...
        case 'g':
            ...
            while(!feof(playlist_file)) {
                ...
                if ( *playlist_len > MAX_SUPPORTED_PLAYBACKS_FOR_GAPLESS) {
                    fprintf(stderr, "Error: Gapless support upto 10 files in playlist \n");
