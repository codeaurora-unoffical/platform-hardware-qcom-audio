...
AUDIO_FEATURE_ENABLED_APTX_OFFLOAD := true
...
AUDIO_FEATURE_ENABLED_BUS_ADDRESS := false 
AUDIO_FEATURE_ENABLED_VHAL_HELPER := false
endif
...
AUDIO_FEATURE_ENABLED_LINE_IN_PASSTHROUGH := true
AUDIO_FEATURE_ENABLED_HDMI_IN_PASSTHROUGH := true
...
AUDIO_FEATURE_ENABLED_EXT_AUDIO_ANC := true
AUDIO_FEATURE_ENABLED_FM_TUNER_EXT := true
AUDIO_FEATURE_ENABLED_ANC := true
...
AUDIO_FEATURE_ENABLED_MULTI_ARCH_LIB := true
AUDIO_FEATURE_ENABLED_LLVM_FLAGS := true
##AUDIO_FEATURE_COMPILE_FLAGS
...
PRODUCT_COPY_FILES += \
    hardware/qcom/audio/configs/msm8996/audio_io_policy.conf:$(TARGET_COPY_OUT_VENDOR)/etc/audio_io_policy.conf \
...
PRODUCT_COPY_FILES += \
    ...
    $(TOPDIR)hardware/qcom/audio/configs/msm8996/eavb_audio_policy_configuration.xml:$(TARGET_COPY_OUT_VENDOR)/etc/eavb_audio_policy_configuration.xml
endif
PRODUCT_COPY_FILES += \
...
PRODUCT_COPY_FILES += \
    hardware/qcom/audio/configs/msm8996/listen_platform_info.xml:$(TARGET_COPY_OUT_VENDOR)/etc/listen_platform_info.xml
